...
//_________________________________________________________________________________
void AnalyzerOptics::CalculateTargetCoords(vector<double> FPVar,vector<double> &TgVar){
...
void AnalyzerOptics::CalculateFocalPlaneCoords(vector<double> DCSVar,vector<double> &FPVar){
	...
	y  = d_y + d_x*ph*tan_rho*cos_rho;
        ...
        if(x==0) cout << "[AnalyzerOptics::CalculateFocalPlaneCoords]: x_fp = 0!" << endl;
